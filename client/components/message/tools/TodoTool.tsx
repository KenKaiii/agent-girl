/**
 * TodoWrite tool component - Task list display with original styling
 */

import React, { useState } from 'react';
import type { ToolUseBlock, TodoItem } from './types';
...
export function TodoToolComponent({ toolUse }: { toolUse: ToolUseBlock }) {
