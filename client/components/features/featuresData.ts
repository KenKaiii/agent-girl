...
import { MessageSquare, Lock, CreditCard, Mail, Package, Shield, Database, Activity, FileUp, AlertCircle, BarChart3, FormInput, Server, Zap, Calendar, Layout, Bot, Puzzle, Monitor, Smartphone, Bell, MapPin, Camera, Home, Workflow, Globe, FileText, Play, LayoutDashboard, Chrome } from 'lucide-react';
import type { Feature } from './types';

const FEATURES_BY_TYPE: Record<string, Feature[]> = {
  nextjs: [
    {
      id: 'ai-chatbot',
      name: 'AI Chatbot',
